...
namespace Seek.API.Security.New
{
    ...
    public class SecureSettingsManager
    {
        ...
        /// </summary>
        public EmailSettings GetSecureEmailSettings()
        {
            try
            {
            ...
            return _configuration.GetSection("EmailSettings").Get<EmailSettings>();
        }

        /// <summary>
        /// Saves email settings to secure encrypted storage
        /// </summary>
        public bool SaveSecureEmailSettings(EmailSettings emailSettings)
        {
            try
            {
